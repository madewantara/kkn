...
@section('title', 'Ubah Data Covid-19')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form class="form-create" id="needs-validation" role="form" method="POST" action="{{ Route('covids.update', ['covid' => $covids->covids_id]) }}" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';" novalidate>
            @csrf
            @method('put')
            <div class="card mt-4">
                ...
                <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="inputName" id="inputName" class="form-control rounded" placeholder="Nama Lengkap" required value="{{ old('inputName') ?? $covids->nama}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="inputGejala" id="inputGejala" class="form-control rounded" placeholder="Gejala" required value="{{ old('inputGejala') ?? $covids->gejala}}">
